#  Project: Login Screen - Dark and Light Modes
### *Responsive login screen design, with dark and light mode button.*

##  Why?

### Project developed to train and develop skills. I used JavaScript to create the button and script for dark/light mode and CSS for styling.
...
### Change mode change code (dark/light): use variables in CSS.
